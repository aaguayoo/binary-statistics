...
#  endif
    ...
    s_python_function_xscale = PyObject_GetAttrString(pymod, "yscale");
...
inline void xscale(const std::string &xscalestr, const std::map<std::string, std::string> &keywords = {})
{
    detail::_interpreter::get();

    PyObject* pyxscalestr = PyString_FromString(xscalestr.c_str());
    PyObject* args = PyTuple_New(1);
    PyTuple_SetItem(args, 0, pyxscalestr);
...
inline void yscale(const std::string &yscalestr, const std::map<std::string, std::string> &keywords = {})
{
    detail::_interpreter::get();

    PyObject* pyyscalestr = PyString_FromString(yscalestr.c_str());
    PyObject* args = PyTuple_New(1);
    PyTuple_SetItem(args, 0, pyyscalestr);
